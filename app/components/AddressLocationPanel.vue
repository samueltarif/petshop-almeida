  ...
  <div class="address-panel" data-component="AddressLocationPanel">
    ...
    <div class="card">
      ...
      <div class="card-content">
        ...
        <a :href="googleMapsLink" target="_blank" rel="noopener" class="address-button">
...
const props = withDefaults(defineProps<Props>(), {
  mapQuery: 'Av. Inajar de Souza, 3823 - Limão, São Paulo - SP, 02717-000',
  mapTitle: 'Mapa',
  howToGetTitle: 'Como Chegar',
  addressTitle: 'Endereço Completo',
  addressLine1: 'Av. Inajar de Souza, 3916, antes do Mercadão D Àgua',
  addressLine2: 'Limão, São Paulo - SP',
  addressZip: 'CEP: 02717-000',
  googleMapsLink: 'https://www.google.com/maps/@-23.4761221,-46.671967,3a,75y,151.04h,96.84t/data=!3m7!1e1!3m5!1skh_pgbuAbmjTX_sjXF6lsw!2e0!6shttps:%2F%2Fstreetviewpixels-pa.googleapis.com%2Fv1%2Fthumbnail%3Fcb_client%3Dmaps_sv.tactile%26w%3D900%26h%3D600%26pitch%3D-6.838083567834715%26panoid%3Dkh_pgbuAbmjTX_sjXF6lsw%26yaw%3D151.04350747986751!7i16384!8i8192?entry=ttu&g_ep=EgoyMDI1MTEwNC4xIKXMDSoASAFQAw%3D%3D',
...
const { mapTitle, howToGetTitle, addressTitle, addressLine1, addressLine2, addressZip, googleMapsLink, mapsLabel } = toRefs(props)
</script>
