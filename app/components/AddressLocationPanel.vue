  ...
  <div class="address-panel" data-component="AddressLocationPanel">
    <div class="card">
      ...
      <div class="card-content">
        <div class="map-wrapper">
          ...
          <a :href="mapsHref" target="_blank" rel="noopener" class="map-link-overlay" aria-label="Abrir endereço no Google Maps"></a>
        </div>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="card-content">
        ...
        <a :href="mapsHref" target="_blank" rel="noopener" class="address-button">
